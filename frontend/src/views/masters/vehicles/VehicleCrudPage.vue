...
<template>
    ...
    <VCardItem>
      <template #title>
        <div class="d-flex align-center justify-space-between flex-wrap gap-4">
          <span class="text-h6">Master Vehicle</span>
  ...
  <VDialog v-model="isFormDialogOpen" max-width="720">
    <VCard>
      <VCardItem :title="isEditMode ? 'Edit Vehicle' : 'Tambah Vehicle'" />
      <VCardText>
        <VForm @submit.prevent="submitForm">
          <VRow>
            <VCol cols="12" md="6">
              <VTextField v-model="form.plate_number" label="Plat Nomor" />
            </VCol>
            <VCol cols="12" md="6">
            ...
            <VCol cols="12" md="6">
              <VTextField v-model="form.brand" label="Brand" />
            </VCol>
            <VCol cols="12" md="6">
  ...
  <VDialog v-model="isDeleteDialogOpen" max-width="420">
    <VCard>
      <VCardItem title="Hapus Vehicle" />
      <VCardText>
        Yakin hapus vehicle <strong>{{ editedItem?.plate_number || editedItem?.id }}</strong>?
      </VCardText>
      <VCardActions class="justify-end">

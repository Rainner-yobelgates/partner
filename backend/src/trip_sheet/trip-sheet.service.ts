...
export class TripSheetService {
  ...
  private serializeTripSheet(t: any) {
    return {
      ...
      crew_incentive: decimalToMoneyString(t.crew_incentive),
      ...
      driver_allowance: decimalToMoneyString(
        t.driver_allowance ?? t.orderVehicle?.order?.driver_allowance ?? null,
      ),
